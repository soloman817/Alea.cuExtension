...
module GF560Ti = 
    ...
    let moderngpu_mergeKeysStats_int32 = [  (  743.271,    5.946);
                                            ( 1517.431,   12.139);
                                            ( 2298.607,   18.389);
                                            ( 3508.165,   28.065);
                                            ( 5636.694,   45.094);
    ...
    let moderngpu_mergeKeysStats_int64 = [  (  724.760,   11.596);
                                            ( 1599.550,   25.593);
                                            ( 2183.630,   34.938);
                                            ( 2884.505,   46.152);
                                            ( 3540.747,   56.652);
    ...
    let moderngpu_mergePairsStats_int32 = [ (  626.086,   10.017);
                                            ( 1317.770,   21.084);
                                            ( 1922.313,   30.757);
                                            ( 2788.777,   44.620);
                                            ( 4018.734,   64.300);
    ...
    let moderngpu_mergePairsStats_int64 = [ (  629.958,   20.159);
                                            ( 1237.109,   39.587);
                                            ( 1648.341,   52.747);
                                            ( 2030.442,   64.974);
                                            ( 2355.326,   75.370);
