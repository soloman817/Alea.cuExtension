module Test.Alea.CUDA.Extension.Output.Util
...
type Entry =
    ...
    new (src, rId, sK, ns, ni, v) = {Source = src; RowID = rId; StatKind = sK; ElementCount = ns; Iterations = ni; Value = v }
...
type BenchmarkStats (algorithmName : string, deviceName : string, testedType : string, opponent : string, sourceCounts : int list, nIterations: int list) =
...
type BenchmarkStats4 =
    ...
    new(algorithmName : string, deviceName : string, opponent : string, sourceCounts : int list, nIterations: int list) =
        { Ints = new BenchmarkStats(algorithmName, deviceName, "Int", opponent, sourceCounts, nIterations);
          Int64s = new BenchmarkStats(algorithmName, deviceName, "Int64", opponent, sourceCounts, nIterations);
          Float32s = new BenchmarkStats(algorithmName, deviceName, "Float32", opponent, sourceCounts, nIterations);
          Floats = new BenchmarkStats(algorithmName, deviceName, "Float", opponent, sourceCounts, nIterations) }

//    member bs4.Ints = bs4.ints
//    member bs4.Int64s = bs4.int64s
//    member bs4.Float32s = bs4.float32s
//    member bs4.Floats = bs4.floats
