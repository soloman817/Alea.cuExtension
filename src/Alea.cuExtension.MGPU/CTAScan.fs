...
//
//
//let inline scanOp (opType:ScanOpType) (ident:int) =
...
//
//    let reduce =
//        <@ fun (tid:int) (x:intV) (storage:deviceptr<'TV>) ->
//            let plus = %plus
//
//            let mutable x = x
...
//
//    let scan =
//        <@ fun (tid:int) (x:intV) (storage:deviceptr<'TV>) (total:deviceptr<'TV>) (stype:int) ->
//            let plus = %plus
//            let extract = %extract
//
//            let mutable x = x
