...
//        
//    <@ fun (source_global:deviceptr<int>) (sourceCount:int) (indices_global:deviceptr<int>) (indicesCount:int) (p_global:deviceptr<int>) (dest_global:deviceptr<int>) ->
//        
...
//
////type IBulkRemove<int> =
////    {
////        Action : ActionHint -> int -> deviceptr<int> -> deviceptr<int> -> deviceptr<int> -> deviceptr<int> -> unit        
////        NumPartitions : int
////    }
//
//type API<int> =
//    {
//        Run : int -> deviceptr<int> -> deviceptr<int> -> deviceptr<int> -> deviceptr<int> -> unit
//        NumPartitions : int
//    }
//
//
...
//            
//            let run (indicesCount:int) (parts:deviceptr<int>) (source_global:deviceptr<int>) (indices_global:deviceptr<int>) (dest_global:deviceptr<int>) =
