...
//// MergePathPartitions
//let kernelMergePartition (NT:int) (bounds:int) (compOp:IComp<int>) =     
//    let bounds = if bounds = 0 then MgpuBoundsLower else MgpuBoundsUpper
...
//type API<int> =
//    {
//        MergePartition : Resources.Kernel<deviceptr<int> -> deviceptr<int> -> deviceptr<int> -> unit>
//    }
////type IMergePathPartitions<int> =
////    {
...
//            let lp = LaunchParam(numPartitionBlocks, NT)
//            
//            let run (a_global:deviceptr<int>) (b_global:deviceptr<int>) (partitionsDevice:deviceptr<int>) =
//                kernelMergePartition.Launch lp a_global aCount b_global bCount nv coop partitionsDevice (numPartitions + 1)
//            run
//             ) }
//
//
//let kernelSetPartition (NT:int) (duplicates:int) (compOp:IComp<int>) =
...
//    
//    <@ fun (a_global:deviceptr<int>) (aCount:int) (b_global:deviceptr<int>) (bCount:int) (nv:int) (bp_global:deviceptr<int>) (numSearches:int) ->
...
//
//
////type IFindSetPartitions<int> =
////    {
////        Action : ActionHint -> deviceptr<int> -> deviceptr<int> -> deviceptr<int> -> unit
////    }
//
//
//let findSetPartitions (duplicates:bool) (compOp:IComp<int>) = cuda {
//    let NT = 64
...
//            let lp = LaunchParam(numPartitionBlocks, NT)
//
//            let run (a_global:deviceptr<int>) (b_global:deviceptr<int>) (parts:deviceptr<int>) =
