...
//
//        let sharedFlags = __shared__.Array<byte>(sharedSize) |> __array_to_ptr
//        let sharedWords = __shared__.Array<int>(sharedSize) |> __array_to_ptr
//        let sharedKeys = __shared__.Array<'TV>(sharedSize) |> __array_to_ptr
//        let sharedValues = __shared__.Array<'TV>(sharedSize) |> __array_to_ptr
//        let sharedRanges = __shared__.Array<int>(NT) |> __array_to_ptr
//
//        let tid = threadIdx.x
...
//
//        let sharedKeys = __shared__.Array<'TV>(NV) |> __array_to_ptr
