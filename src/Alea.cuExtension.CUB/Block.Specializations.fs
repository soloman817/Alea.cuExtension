...
//            let BlockRakingLayout = block_threads |> RakingLayout.BlockRakingLayout<'T>.Init 
...
//    type TempStorage<'T> =
//        {
//            warp_scan : deviceptr<'T> //Alea.cuExtension.CUB.Warp.Scan.ITempStorage<'T>
//            raking_grid : deviceptr<'T> //Alea.cuExtension.CUB.Block.RakingLayout.ITempStorage<'T>
//            block_aggregate : 'T
//        }
//    
//    [<Record>]
