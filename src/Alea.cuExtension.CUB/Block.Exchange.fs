...
//let warp_lane = linear_tid &&& (WARP_THREADS - 1)
//let warp_offset = 
//    fun items_per_thread block_threads -> 
//        fun tidx ->
//            (warp_id >> linear_tid |> tidx) * ((block_threads, items_per_thread) ||> WARP_TIME_SLICED_ITEMS)
//
//
// 
//
