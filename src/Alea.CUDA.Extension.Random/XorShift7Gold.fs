module Alea.CUDA.Extension.Random.XorShift7Gold
...
type XorShift7Rng(state:uint32[]) =
    ...
    new (seed:uint32) = XorShift7Rng(XorShift7.generateStartState(seed))
    ...
    member this.NextUniformFloat32() =
        this.NextUniformUInt32() |> XorShift7.toFloat32

    member this.NextUniformFloat64() =
        this.NextUniformUInt32() |> XorShift7.toFloat64
