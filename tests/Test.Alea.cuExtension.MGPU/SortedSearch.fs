module Test.Alea.cuBase.MGPU.SortedSearch
...
open Alea.cuBase.MGPU.SortedSearch
open Test.Alea.cuBase.MGPU.Util
open Test.Alea.cuBase.MGPU.BenchmarkStats
open Alea.cuBase.IO.Util
open Alea.cuBase.IO.CSV
open Alea.cuBase.IO.Excel

open NUnit.Framework

////////////////////////////
// set this to your device or add your device's C++ output to BenchmarkStats.fs
open Test.Alea.cuBase.MGPU.BenchmarkStats.GF560Ti
